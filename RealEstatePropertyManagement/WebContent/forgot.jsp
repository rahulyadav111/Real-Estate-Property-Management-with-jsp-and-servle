			...
			<div
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="pannel-title">Please-create your new password</h3>
					</div>
					<div class="pannel-body">
						<form class="form" action="forgotAction.jsp" method="post">
							...
							<div class="form-group">
								<input type="password" name="re_password" id="password"
									class="form-control input-sm" placeholder="Re-Enter your new password">
							</div>
