			...
			<div
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="pannel-title">Please-Sign_UP</h3>
					</div>
					<div class="pannel-body">
						<form class="form" action="Sign_upAction.jsp" method="post">
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-ms-6">
							<div class="account">
								<a href="index.jsp">are you new user!</a>
							</div>
						</div>
						<div class="col-xs-6 col-sm-6 col-ms-6">
							<div class="account">
